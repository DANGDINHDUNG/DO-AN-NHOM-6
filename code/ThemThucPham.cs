    ...
    public partial class ThemThucPham : Form
    {
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmdexcel1.CommandText = "select F1 as TENTP, F2 as GIATIEN, F3 as MALTP from[" + sheetName + "]";
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.FileName = "danh_sach_them_thuc_pham_mau";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Thực phẩm đã được thêm thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
